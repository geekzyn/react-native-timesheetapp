...
class HomeScreen extends React.Component {
		...
		showData = () => {
			...
			render() {
				...
				return ( <View style = {{flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#D499D4'}}>
					<Text > Home Screen </Text> 
					{this.showData()} 
					<TouchableOpacity style = {{backgroundColor: 'red', height: 20}}
					onPress = {() => this.props.navigation.navigate('Dashboard')}>
					<Text style = {{color: 'white'}} > GO TO Dashboard </Text> 
					</TouchableOpacity>
					<TouchableOpacity style = {{ backgroundColor: 'green', height: 20}}
